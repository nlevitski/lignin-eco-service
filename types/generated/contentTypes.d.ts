...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    integratedInfo: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    topContent: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiFeatureSectionFeatureSection
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feature_icons: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-icon.feature-icon'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    buttonTargetDocumentId: Schema.Attribute.UID &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMenuLinkMenuLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    anchorType: Schema.Attribute.Enumeration<['section', 'article']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    order: Schema.Attribute.Integer &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    targetDocumentId: Schema.Attribute.UID &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNotFoundNotFound extends Struct.SingleTypeSchema {
  ...
  attributes: {
    buttonValue: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPhonePhone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    country: Schema.Attribute.Enumeration<['BY', 'RU', 'PL']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSitemapLinkSitemapLink extends Struct.SingleTypeSchema {
  collectionName: 'sitemap_links';
  info: {
    displayName: 'Sitemap-link';
